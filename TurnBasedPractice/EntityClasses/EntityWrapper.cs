...
namespace TurnBasedPractice.EntityClasses
{
    public class EntityWrapper
    {
        ...
        private List<EntityAbstract> _listOfEntities = new List<EntityAbstract>();
        ...
        public EntityWrapper(string tmpType)
        {
            ...
            if (tmpType == "Entity")
            {
                ...
                this._ActivePath = this._EPath;
                string encryptedEntities = this._EntityEncrypter.decryptFile(this._EPath);
        ...
        public void saveEntities()
        {
            ...
            foreach (EntityAbstract tmpItem in _listOfEntities)
            {
        ...
        //###Modify & Get of Items
        public List<EntityAbstract> getEntities()
        {
        ...
        public EntityAbstract getEntity(int tmpID)
        {
            
            foreach (EntityAbstract tmpEntity in this._listOfEntities)
            {
