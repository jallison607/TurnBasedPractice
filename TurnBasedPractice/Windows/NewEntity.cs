...
namespace TurnBasedPractice.Windows
{
    public partial class NewEntity : Form
    {
        ...
        {
            InitializeComponent();
            this._entityWrapper = new EntityWrapper("Entity");
        ...
        //Events
        private void NewEntity_Load(object sender, EventArgs e)
        {
            populateDataGrid();
        }
        ...
        private void btnAddEdit_Click(object sender, EventArgs e)
        {
            if (selectedEntityID == -1)
            {
                ...
                Entity tmpNewEntity = new Entity(tmpID, this.txtName.Text, (int)this.nLevel.Value, selectedWep, (int)this.nMaxHP.Value, (int)nSpeed.Value);
                this._entityWrapper.AddEntity(tmpNewEntity);
        ...
        private void clearInfo()
        {
            ...
            this.nMaxHP.Value = this.nMaxHP.Minimum;
        ...
        private void populateDataGrid()
        {
            ...
            entityList = this._entityWrapper.getEntities();
        ...
        private void dgvEntities_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (this.dgvEntities.SelectedRows.Count > 0)
            {
                ...
                Entity selectedEntity = (Entity)this._entityWrapper.getEntity(tmpID);
                this.txtName.Text = selectedEntity.name;
                this.nMaxHP.Value = selectedEntity.getMaxHP();
                this.nLevel.Value = selectedEntity.getLevel();
                ...
                this.nSpeed.Value = selectedEntity.getSpeed();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (this.dgvEntities.SelectedRows.Count > 0)
            {
                int tmpID = Int32.Parse(this.dgvEntities.SelectedRows[0].Cells[0].Value.ToString());
                Entity selectedEntity = (Entity)this._entityWrapper.getEntity(tmpID);
                textBox1.Text = selectedEntity.ToEString();
            }
        }
